...
const apiKeyMiddleware = (req, res, next) => {
    ...
    return (0, Function_1.pipe)(apiKey, primitiveParsers_1.safeParseNonEmptyString, effect_1.Effect.orElseFail(() => new customErrors_1.AuthorisationError({ message: "No API key provided" })), effect_1.Effect.flatMap((apiKey) => {
